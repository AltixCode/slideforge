...
import { useSlideStore } from '../src/store/useSlideStore';
...
export default function RootLayout() {
  ...
  const { isPro, setIsPro } = useSlideStore();
  ...
  return (
    <>
      ...
      >
        ...
        <Stack.Screen name="preview" options={{ title: t('previewTitle'), headerBackTitle: t('back') }} />
        <Stack.Screen
          name="paywall"
          options={{
